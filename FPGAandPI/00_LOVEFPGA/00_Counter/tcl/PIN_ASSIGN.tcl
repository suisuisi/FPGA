...
#按键对应的引脚
set_location_assignment	PIN_T14	-to dipkey_in[0]
set_location_assignment	PIN_T15	-to dipkey_in[1]
set_location_assignment	PIN_P14	-to dipkey_in[2]
set_location_assignment	PIN_N14	-to dipkey_in[3]
