...
set_location_assignment	PIN_N6	-to Scan_Sig[5]
set_location_assignment	PIN_P6	-to Scan_Sig[4]
set_location_assignment	PIN_M6  -to Scan_Sig[3]
set_location_assignment	PIN_M7	-to Scan_Sig[2]
set_location_assignment	PIN_P8	-to Scan_Sig[1] 
set_location_assignment	PIN_N8	-to Scan_Sig[0]
