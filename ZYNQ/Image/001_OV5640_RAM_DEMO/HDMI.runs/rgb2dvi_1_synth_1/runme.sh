...
HD_PWD='F:/FILE/FPGA/ZYNQ/TEST/OV5640_Nexys_Video_CSDN/OV5640_Nexys_Video_CSDN/HDMI/HDMI.runs/rgb2dvi_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2dvi_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2dvi_1.tcl
