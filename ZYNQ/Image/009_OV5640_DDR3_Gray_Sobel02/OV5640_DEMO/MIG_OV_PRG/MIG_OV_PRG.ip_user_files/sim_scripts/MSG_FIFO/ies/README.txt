...
#
# Generated by export_simulation on Sat Oct 19 22:46:05 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './MSG_FIFO.sh' script.

./MSG_FIFO.sh -reset_run
...
./MSG_FIFO.sh -noclean_files

For more information on the script, please type './MSG_FIFO.sh -help'.
