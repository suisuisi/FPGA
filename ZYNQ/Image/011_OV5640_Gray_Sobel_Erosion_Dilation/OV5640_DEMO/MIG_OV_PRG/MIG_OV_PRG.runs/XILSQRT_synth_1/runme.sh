...
HD_PWD='F:/FILE/FPGA/ZYNQ/Image/005_OV5640_DDR3_Gray_Sobel/OV5640_DEMO/MIG_OV_PRG/MIG_OV_PRG.runs/XILSQRT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XILSQRT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XILSQRT.tcl
