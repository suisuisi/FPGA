...
#
# Generated by export_simulation on Sat Oct 19 22:46:00 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './CH6_FIFO.sh' script.

./CH6_FIFO.sh -reset_run
...
./CH6_FIFO.sh -noclean_files

For more information on the script, please type './CH6_FIFO.sh -help'.
