...
#
# Generated by export_simulation on Sat Oct 19 22:45:53 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './CH0_FIFO.sh' script.

./CH0_FIFO.sh -reset_run
...
./CH0_FIFO.sh -noclean_files

For more information on the script, please type './CH0_FIFO.sh -help'.
