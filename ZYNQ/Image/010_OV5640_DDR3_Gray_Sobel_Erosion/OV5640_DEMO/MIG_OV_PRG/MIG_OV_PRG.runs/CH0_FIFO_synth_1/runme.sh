...
HD_PWD='F:/FILE/FPGA/ZYNQ/zynq_7035/TEST/CH04_OV5640_DEMO/OV5640_TS_DATA/MIG_OV_PRG/MIG_OV_PRG.runs/CH0_FIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CH0_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CH0_FIFO.tcl
