...
HD_PWD='F:/FILE/FPGA/ZYNQ/Image/003_OV5640_DDR3_Gray_Mean_Filter/OV5640_DEMO/MIG_OV_PRG/MIG_OV_PRG.runs/Line_Shift_RAM_8Bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Line_Shift_RAM_8Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Line_Shift_RAM_8Bit.tcl
